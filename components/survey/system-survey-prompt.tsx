...
export function SystemSurveyPrompt({ hasCompletedSurvey = false }: SystemSurveyPromptProps) {
  ...
  const [submitted, setSubmitted] = useState(hasCompletedSurvey)
  ...
  useEffect(() => {
    ...
    try {
      ...
      window.localStorage.removeItem("acob-survey-submitted")
    } catch {
      // ignore
    }

    if (!hasCompletedSurvey && !submitted) {
      setIsPromptOpen(true)
    }
  }, [hasCompletedSurvey, submitted])
            ...
            <DialogHeader className="gap-3 pt-1 text-left">
              ...
              <div className="space-y-1.5">
                ...
                <DialogDescription className="text-muted-foreground text-xs leading-relaxed">
                  We recently deployed key system updates. Take 2 minutes to let us know how the system is performing
                  for your daily work.
                </DialogDescription>
              </div>
            </DialogHeader>
