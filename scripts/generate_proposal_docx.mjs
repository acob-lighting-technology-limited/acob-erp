...
const inputPath =
  "/Users/chibuike/.gemini/antigravity/brain/9119259c-6c73-4f8c-a2a2-7c8735091661/implementation_plan.md"
...
async function createDocx() {
  ...
  children.push(
    new Paragraph({
      alignment: AlignmentType.CENTER,
      children: [new TextRun({ text: "ACOB Lighting Technology Limited", size: 24, italics: true })],
      spacing: { after: 800 },
    })
  )
          ...
          default: new Footer({
            children: [
              new Paragraph({
                ...
                children: [
                  new TextRun({
                    text: "Confidential - ACOB Lighting Technology Limited | Page ",
                    size: 18,
                    color: "969696",
                  }),
