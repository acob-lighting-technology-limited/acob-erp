-- ============================================
-- Simplified Fix for Audit Logs RLS Policy for Leads
-- ============================================
  ...
  EXISTS (
    ...
    AND (
      ...
      EXISTS (
        ...
        AND (
          (COALESCE(array_length(p.lead_departments, 1), 0) > 0 AND p2.department = ANY(p.lead_departments))
          OR
          (COALESCE(array_length(p.lead_departments, 1), 0) = 0 AND p2.department = p.department)
        )
      )
      OR
      ...
      (
        ...
        AND EXISTS (
          ...
          AND (
            (COALESCE(array_length(p.lead_departments, 1), 0) > 0 AND p3.department = ANY(p.lead_departments))
            OR
            (COALESCE(array_length(p.lead_departments, 1), 0) = 0 AND p3.department = p.department)
          )
        )
      )
      OR
      ...
      (
        ...
        AND EXISTS (
          ...
          AND (
            (COALESCE(array_length(p.lead_departments, 1), 0) > 0 AND t.department = ANY(p.lead_departments))
            OR
            (COALESCE(array_length(p.lead_departments, 1), 0) = 0 AND t.department = p.department)
          )
        )
      )
      OR
      ...
      (
        ...
        AND EXISTS (
          ...
          AND (
            (COALESCE(array_length(p.lead_departments, 1), 0) > 0 AND p4.department = ANY(p.lead_departments))
            OR
            (COALESCE(array_length(p.lead_departments, 1), 0) = 0 AND p4.department = p.department)
          )
        )
      )
      OR
      ...
      (
        ...
        AND EXISTS (
          ...
          AND (
            (COALESCE(array_length(p.lead_departments, 1), 0) > 0 AND (
      ...
      (
        ...
        AND EXISTS (
          ...
          AND (
            (COALESCE(array_length(p.lead_departments, 1), 0) > 0 AND p6.department = ANY(p.lead_departments))
            OR
            (COALESCE(array_length(p.lead_departments, 1), 0) = 0 AND p6.department = p.department)
          )
        )
      )
    )
