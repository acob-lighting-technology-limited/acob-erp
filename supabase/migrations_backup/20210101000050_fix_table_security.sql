...
-- Note: token_records already has 'employee create token records' and 'employee read token records' policies using has_role('employee')
...
-- but better to rely on the existing "employee" and "Admin" policies.
...
-- "employee create/read/update meters" (has_role('employee'))
