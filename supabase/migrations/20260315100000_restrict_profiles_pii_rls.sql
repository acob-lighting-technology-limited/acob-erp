...
-- We keep profiles_select_own and profiles_select_admin as-is.
-- No additional broad colleague SELECT policy is created here.
-- Dept leads wishing to see their reports should query profiles_public.
