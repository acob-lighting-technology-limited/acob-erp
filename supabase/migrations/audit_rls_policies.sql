...
-- =====================================================
-- 2. TEST AS STAFF (should have limited access)
-- =====================================================
...
SELECT 'Testing staff access to profiles' as test;
SELECT COUNT(*) as profile_count FROM profiles; -- Should see all profiles

SELECT 'Testing staff access to office locations' as test;
SELECT COUNT(*) as location_count FROM office_locations; -- Should see all

SELECT 'Testing staff access to payments' as test;
...
-- Try to create a payment (should fail for staff/visitor)
...
-- VALUES (gen_random_uuid(), 'Test', 'User', 'test@example.com', 'staff');
