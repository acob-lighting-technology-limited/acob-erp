...
BEGIN
    ...
    -- Defensive access to potentially null records
    v_new_values := jsonb_build_object(
        ...
        'assigned_to_employee_number', CASE WHEN v_assigned_user.id IS NOT NULL THEN v_assigned_user.employee_number ELSE NULL END,
        ...
        'assigned_from_employee_number', CASE WHEN v_from_user.id IS NOT NULL THEN v_from_user.employee_number ELSE NULL END
    );
...
EXCEPTION
    WHEN OTHERS THEN
        -- Optionally log error details to help debug
