...
export function HelpDeskContent({
  ...
  async function createTicket(e: React.FormEvent) {
    ...
    try {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      toast.error((error as any).message || "Failed to create ticket")
    } finally {
      setIsSaving(false)
    }
  }
  ...
  async function setStatus(ticketId: string, status: string) {
    try {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      toast.error((error as any).message || "Update failed")
    }
  }
  ...
  async function rateTicket(ticketId: string, rating: number) {
    try {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      toast.error((error as any).message || "Failed to submit rating")
    }
  }
  ...
  async function openTicketDetails(ticketId: string) {
    ...
    try {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      toast.error((error as any).message || "Failed to load ticket details")
