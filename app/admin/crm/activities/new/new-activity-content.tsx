...
export function NewActivityContent({ initialContacts, preselectedContactId: propContactId }: NewActivityContentProps) {
  ...
  // Contacts provided via props, load remaining data
  useEffect(() => {
    loadData()
  }, [])
  ...
  const loadData = async () => {
    try {
      const [opportunitiesRes, usersRes] = await Promise.all([
