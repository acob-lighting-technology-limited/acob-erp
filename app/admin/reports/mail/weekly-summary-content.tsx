...
export function WeeklySummaryContent({ employees, currentUser }: Props) {
  ...
  const { data: resolvedMeetingDate } = useQuery({
    queryKey: ["meeting-mail-effective-date", weekNumber, yearNumber],
    queryFn: async () => resolveEffectiveMeetingDateIso(supabase, weekNumber, yearNumber),
  })
  ...
  const autogeneratedActionPointsName = useMemo(
    ...
    [resolvedMeetingDate, weekNumber, yearNumber]
  )
