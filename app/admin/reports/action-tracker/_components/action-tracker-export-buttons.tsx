...
export function ActionTrackerExportButtons({ items, weekFilter, yearFilter }: ActionTrackerExportButtonsProps) {
  return (
    <div className="flex items-center gap-2">
      <Button
        variant="outline"
        onClick={() => exportActionTrackerToPDF(items, weekFilter, yearFilter)}
      ...
      <Button
        variant="outline"
        onClick={() => exportActionTrackerToPPTX(items, weekFilter, yearFilter)}
      ...
      <Button
        variant="outline"
        onClick={() => exportActionTrackerToDocx(items, weekFilter, yearFilter)}
      ...
      <Button
        variant="outline"
        onClick={() => exportActionTrackerToXLSX(items, weekFilter, yearFilter)}
