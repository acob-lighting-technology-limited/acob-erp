      ...
      {tab === "department" ? (
        <DataTable<GoalWithCycle>
          ...
          rowActions={[
            {
              ...
              icon: ListPlus,
              onClick: (row) =>
                router.push(`${goalsBasePath ?? "/admin/pms/goals"}/task?goal_id=${encodeURIComponent(row.id)}`),
            },
            {
              label: "Archive Goal",
              icon: Trash2,
          ...
          mobileRow={{
            ...
            onSelect: (r) =>
              router.push(`${goalsBasePath ?? "/admin/pms/goals"}/task?goal_id=${encodeURIComponent(r.id)}`),
          }}
          cardRenderer={(r) => (
