...
export async function AdminPmsPage({ basePath, cycleId }: { basePath?: string; cycleId?: string } = {}) {
  ...
  const visibleLinks = adminPmsLinks
    .filter((item) => item.href !== "/admin/pms/cbt" || canAccessCbtCard)
