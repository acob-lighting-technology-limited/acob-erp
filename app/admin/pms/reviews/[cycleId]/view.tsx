...
export function AdminPmsQuarterReviewsPage({ backLinkHref }: { backLinkHref?: string } = {}) {
  ...
  function handleTabChange(nextMode: string) {
    ...
    router.replace(`/admin/pms/reviews/${encodeURIComponent(cycleId)}?${p.toString()}`)
  }
  ...
  return (
    <DataTablePage
      ...
      icon={FileText}
      backLink={{ href: backLinkHref ?? "/admin/pms/reviews", label: "Back to PMS Reviews" }}
      tabs={pageTabs}
      activeTab={mode}
