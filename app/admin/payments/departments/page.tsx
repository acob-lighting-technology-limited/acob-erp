        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-foreground text-2xl font-bold md:text-3xl">Department Management</h1>
            </div>
            <p className="text-muted-foreground text-sm">Manage departments for payment organization</p>
          </div>
                ...
                {departments.map((department) => (
                  ...
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <h3 className="text-foreground font-semibold">{department.name}</h3>
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="outline" size="sm" onClick={() => handleOpenDialog(department)}>
